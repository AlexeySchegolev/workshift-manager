...
locationsControllerActivate: (id: number, params: RequestParams = {}) =>
    this.request<LocationResponseDto, void>({
 ...
 */
locationsControllerCreate: (data: CreateLocationDto, params: RequestParams = {}) =>
    this.request<LocationResponseDto, void>({
        path: `/api/locations`,
        method: 'POST',
 ...
 */
locationsControllerFindAll: (query?: {
 ...
 */
locationsControllerFindOne: (id: number, query?: {
  /** Include employee relationships in response */
    includeEmployees?: boolean,
 ...
 */
locationsControllerGetLocationWithStats: (id: number, params: RequestParams = {}) =>
    this.request<({
 ...
 */
locationsControllerSearch: (query: {
 ...
 */
locationsControllerUpdate: (id: number, data: UpdateLocationDto, params: RequestParams = {}) =>
    this.request<LocationResponseDto, void>({
        path: `/api/locations/${id}`,
        method: 'PATCH',
                body: data,                type: ContentType.Json,        format: "json",        ...params,
