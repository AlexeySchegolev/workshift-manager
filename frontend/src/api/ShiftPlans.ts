...
export class ShiftPlans<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
 ...
 */
shiftPlansControllerCreate: (data: CreateShiftPlanDto, params: RequestParams = {}) =>
    this.request<ShiftPlanResponseDto, void>({
 ...
 */
shiftPlansControllerFindAll: (query?: {
  /** Include assignments and violations in response */
    includeRelations?: boolean,

}, params: RequestParams = {}) =>
    this.request<(ShiftPlanResponseDto)[], any>({
        path: `/api/shift-plans`,
        method: 'GET',
 ...
 */
shiftPlansControllerFindByMonthYear: (year: number, month: number, params: RequestParams = {}) =>
    this.request<ShiftPlanResponseDto, void>({
 ...
 */
shiftPlansControllerFindOne: (id: string, query?: {
  /** Include assignments and violations in response */
    includeRelations?: boolean,
 ...
 */
shiftPlansControllerGenerate: (data: GenerateShiftPlanDto, params: RequestParams = {}) =>
    this.request<{
    shiftPlan?: any,
    statistics?: object,
    violations?: (any)[],
 ...
 */
shiftPlansControllerUpdate: (id: string, data: UpdateShiftPlanDto, params: RequestParams = {}) =>
    this.request<ShiftPlanResponseDto, void>({
        path: `/api/shift-plans/${id}`,
        method: 'PATCH',
                body: data,                type: ContentType.Json,        format: "json",        ...params,
 ...
 */
shiftPlansControllerValidate: (data: ValidateShiftPlanDto, params: RequestParams = {}) =>
    this.request<{
    isValid?: boolean,
    statistics?: object,
    violations?: (any)[],
