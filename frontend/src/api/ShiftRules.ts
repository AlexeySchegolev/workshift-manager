...
export class ShiftRules<SecurityDataType = unknown> extends HttpClient<SecurityDataType>  {
...
shiftRulesControllerActivate: (id: string, params: RequestParams = {}) =>
    this.request<ShiftRulesResponseDto, void>({
 ...
 */
shiftRulesControllerCreate: (data: CreateShiftRulesDto, params: RequestParams = {}) =>
    this.request<ShiftRulesResponseDto, void>({
...
shiftRulesControllerFindActive: (params: RequestParams = {}) =>
    this.request<(ShiftRulesResponseDto)[], any>({
 ...
 */
shiftRulesControllerFindAll: (query?: {
 ...
 */
shiftRulesControllerUpdate: (id: string, data: UpdateShiftRulesDto, params: RequestParams = {}) =>
    this.request<ShiftRulesResponseDto, void>({
        path: `/api/shift-rules/${id}`,
        method: 'PATCH',
                body: data,                type: ContentType.Json,        format: "json",        ...params,
