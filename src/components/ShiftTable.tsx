...
const ShiftTable: React.FC<ShiftTableProps> = ({
  ...
  const getShiftBackgroundColor = (shift: string): string => {
    switch (shift) {
      case 'F': return alpha(theme.palette.shifts?.early || theme.palette.success.main, 0.1);
      case 'S': 
      case 'S0':
      case 'S1':
      case 'S00': return alpha(theme.palette.shifts?.late || theme.palette.warning.main, 0.1);
      case 'FS': return alpha(theme.palette.shifts?.special || theme.palette.info.main, 0.1);
      case '4':
      case '5':
      case '6': return alpha(theme.palette.shifts?.uetersen || theme.palette.info.main, 0.1);
  ...
  const getShiftColor = (shift: string): string => {
    switch (shift) {
      case 'F': return theme.palette.shifts?.early || theme.palette.success.main;
      case 'S': 
      case 'S0':
      case 'S1':
      case 'S00': return theme.palette.shifts?.late || theme.palette.warning.main;
      case 'FS': return theme.palette.shifts?.special || theme.palette.info.main;
      case '4':
      case '5':
      case '6': return theme.palette.shifts?.uetersen || theme.palette.info.main;
  ...
  const getConstraintIcon = (status: ConstraintStatus) => {
    switch (status) {
      case 'ok': return <CheckCircleIcon sx={{ fontSize: '1rem' }} />;
      case 'warning': return <WarningIcon sx={{ fontSize: '1rem' }} />;
      case 'violation': return <ErrorIcon sx={{ fontSize: '1rem' }} />;
